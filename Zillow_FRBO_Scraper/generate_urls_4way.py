...
state3['filterState']['mp'] = {'min': 1901, 'max': 3000}
...
state4['filterState']['mp'] = {'min': 3001}
state4['filterState']['price'] = {'max': 300000}
url4 = f"https://www.zillow.com/chicago-il/rentals/?searchQueryState={urllib.parse.quote(json.dumps(state4))}"

with open('urls_4way.txt', 'w') as f:
    f.write(f"{url1}\n{url2}\n{url3}\n{url4}")
